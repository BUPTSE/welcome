...
在校外必须使用学校的VPN才能访问内网的资源。可以使用\href{https://webvpn.bupt.edu.cn/}{WebVPN}，也可以使用专门的客户端\href{https://vpn2.bupt.edu.cn/}{aTrust（推荐）}。
\subsection{常用网站}
...
\begin{itemize}
    ...
    \item \href{https://vpn2.bupt.edu.cn/}{aTrust VPN系统}：使用客户端访问内网资源，支持电脑和手机使用。
